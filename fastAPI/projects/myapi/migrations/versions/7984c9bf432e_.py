...
Revision ID: 7984c9bf432e
Revises: 7cd9d991386b
Create Date: 2026-05-07 14:31:09.396539
...
revision: str = '7984c9bf432e'
down_revision: Union[str, Sequence[str], None] = '7cd9d991386b'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['question_id'], ['question.id'], name=op.f('fk_answer_voter_question_id_question')),
